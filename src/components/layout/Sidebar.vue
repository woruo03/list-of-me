<template>
  <aside
    class="bg-base-200 border-r border-base-300 flex flex-col duration-200 transition-[width] overflow-hidden"
    :class="sidebarClass"
  >
    <div
      class="border-b border-base-300 flex items-center justify-between"
    ...
    >
      ...
      <button class="btn btn-ghost btn-sm flex-shrink-0" @click="uiStore.toggleSidebar">☰</button>
    </div>
