<template>
  <div class="min-h-screen bg-base-100 flex">
    ...
    <nav class="md:hidden fixed bottom-0 left-0 right-0 bg-base-100 border-t border-base-300">
      <div class="flex justify-around py-2">
        <router-link class="btn btn-ghost btn-sm" to="/inbox">📥</router-link>
        <router-link class="btn btn-ghost btn-sm" to="/today">📅</router-link>
        <router-link class="btn btn-ghost btn-sm" to="/projects">📁</router-link>
        <router-link class="btn btn-ghost btn-sm" to="/completed">✅</router-link>
      </div>
    </nav>
